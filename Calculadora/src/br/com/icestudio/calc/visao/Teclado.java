...
public class Teclado extends JPanel implements ActionListener{
	...
	private final Color COR_LARNJA = new Color(242, 163, 60);
	...
	public Teclado() {
		 ...
		 adicionarBotao("=", COR_LARNJA, c, 3, 4);
